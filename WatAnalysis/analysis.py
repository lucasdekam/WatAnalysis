...
class WaterAnalysis(AnalysisBase):
    ...
    **kwargs : dict
    ...
    def _single_frame(self):
        ...
        dipole = structure.calc_water_dipoles(
            coords_hydrogen,
            coords_oxygen,
            self.water_dict,
            box=ts_box,
    ...
    def density_profile(
        ...
        return structure.calc_density_profile(
    ...
    def orientation_profile(
        ...
        return structure.calc_orientation_profile(
            (self.results.z1.mean(), self.results.z2.mean()),
    ...
    def costheta_profile(
        ...
        return structure.calc_costheta_profile(
            (self.results.z1.mean(), self.results.z2.mean()),
            self.results.z_water,
            self.results.cos_theta,
            dz,
    ...
    def angular_distribution(
        ...
        return structure.calc_angular_distribution(
            mask_lo & valid,
            mask_hi & valid,
            self.results.cos_theta,
            n_bins=n_bins,
    ...
    def survival_probability(
        ...
        return dynamics.calc_survival_probability(
            max_tau=max_tau,
            delta_tau=delta_tau,
            step=step,
